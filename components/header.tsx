        ...
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden lg:flex items-center gap-6">
            {navLinks.map((link) => (
              <a
                key={link.href}
                href={link.href}
                className="text-sm text-[#8ba3c0] underline-offset-4 transition-colors duration-200 hover:text-[#00e5ff] hover:underline"
              >
                {link.label}
              </a>
            ))}
          ...
          <div className="hidden lg:flex items-center gap-4">
            <a
              href="#"
              aria-label="LinkedIn"
              className="text-[#012e43] transition-colors duration-200 hover:text-[#00e5ff]"
            >
